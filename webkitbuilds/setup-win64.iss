...
[Files]
; Source: "..\wntbuilds\wnt-test\win64\wnt.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\..\wntbuilds\{#MyAppPackageName}\win64\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
