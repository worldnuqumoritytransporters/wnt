...
angular.module('copayApp.controllers').controller('recoveryFromSeed',
	function ($rootScope, $scope, $log, $timeout, profileService) {
		...
		var wallet_defined_by_keys = require('wntcore/wallet_defined_by_keys.js');
		var objectHash = require('wntcore/object_hash.js');
		try{
			var ecdsa = require('secp256k1');
		}
		catch(e){
			var ecdsa = require('wntcore/node_modules/secp256k1' + '');
		}
		var Mnemonic = require('bitcore-mnemonic');
		var Bitcore = require('bitcore-lib');
		var db = require('wntcore/db.js');
		var network = require('wntcore/network');
		var myWitnesses = require('wntcore/my_witnesses');
		...
		function cleanAndAddWalletsAndAddresses(assocMaxAddressIndexes) {
			var device = require('wntcore/device');
