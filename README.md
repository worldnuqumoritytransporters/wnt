World Nuqumority Token is a wallet for storage and transfer of decentralized value.  See [wnt.jp](https://wnt.jp/).

## Binary Downloads

[wnt.jp](https://wnt.com/)
...
```sh
git clone https://github.com/wnt/wnt.git
cd wnt
```
...
- Run `make ios-debug`
  ...
  * On code signing error, open Xcode project `../byteballbuilds/project-IOS/platforms/ios/wnt.xcodeproj` in Xcode, open project properties, select wnt target and set your AppleID account as a team. Xcode may also ask you to change bundle identifier to be unique, just append any random string to 'org.wnt.wallet' bundle identifier.

### macOS

- `grunt desktop`
- copy `node_modules` into the app bundle ../byteballbuilds/wnt/osx64/wnt.app/Contents/Resources/app.nw, except those that are important only for development (karma, grunt, jasmine)
- `grunt dmg`

### Windows

- `grunt desktop`
- copy `node_modules` into the app bundle ../byteballbuilds/wnt/win64, except those that are important only for development (karma, grunt, jasmine)
- `grunt inno64`

### Linux

- `grunt desktop`
- copy `node_modules` into the app bundle ../byteballbuilds/wnt/linux64, except those that are important only for development (karma, grunt, jasmine)
- `grunt linux64`
...
* [GitHub Issues](https://github.com/wnt/wnt/issues)
  * Open an issue if you are having problems with this project
* [Email Support](mailto:wnt@worldnuqumoritytoken.com )
